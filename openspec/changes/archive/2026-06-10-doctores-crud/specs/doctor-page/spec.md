...
Status: there is no existing main spec under `openspec/specs/doctor-page/`
— this change introduces the domain from scratch. All requirements below are
`ADDED`. Future modifications to the page must be expressed as
